...
PVOID sendVideoPackets(PVOID args)
{
    ...
    PCodecStreamConf pCodecStreamConf = &pFileSrcContext->codecConfiguration.videoStream;
...
PVOID sendAudioPackets(PVOID args)
{
    ...
    PCodecStreamConf pCodecStreamConf = &pFileSrcContext->codecConfiguration.audioStream;
    pCodecStreamConf->pFrameBuffer = NULL;
    pCodecStreamConf->frameBufferSize = 0;
    frame.presentationTs = 0;
...
PVOID runMediaSource(PVOID args)
{
    ...
    THREAD_CREATE(&videoSenderTid, sendVideoPackets, (PVOID) pFileSrcContext);
    THREAD_CREATE(&audioSenderTid, sendAudioPackets, (PVOID) pFileSrcContext);
